...
#pragma endregion
	...
	for (int i = 0; i < LABEL_COUNT; i++)
	{
		...
		{
			m_labels[i] = new Label(&m_strings[i], &m_font, &sf::Vector2f(370, 100 + (i * 130)), 32, sf::Color(140, 80, 160));
			m_outline[i] = new Label(&m_strings[i], &m_font, &sf::Vector2f(373, 100 + (i * 130)), 32, sf::Color(195, 80, 215));
		}
